...
#set document(title: [Komunikasi Interpersonal dan Publik], author: ("Armein Z. R. Langi",))
#show: book.with(
...
#heading(level: 2, numbering: none)[Selamat Datang]
<selamat-datang>
...
#heading(level: 3, numbering: none)[Pola 4P]
<pola-4p>
...
#heading(level: 3, numbering: none)[Rute TAIDA]
<rute-taida>
...
#heading(level: 3, numbering: none)[Cara Belajar yang Disarankan]
...
#heading(level: 3, numbering: none)[Sikap Dasar Pembaca]
<sikap-dasar-pembaca>
...
#heading(level: 3, numbering: none)[Bagian I: Menemukan Diri di Dalam Percakapan]
...
#heading(level: 3, numbering: none)[Bagian II: Membangun Relasi yang Dipercaya]
...
#heading(level: 3, numbering: none)[Bagian III: Dari Ketertarikan Menuju Tindakan]
...
#heading(level: 3, numbering: none)[Bagian IV: Menjadi Komunikator Publik]
...
#heading(level: 3, numbering: none)[Bagian V: Menjadi Life Star]
...
#heading(level: 3, numbering: none)[Peta Kompetensi]
<peta-kompetensi>
...
#heading(level: 2, numbering: none)[Pendahuluan]
<pendahuluan>
...
#heading(level: 1, numbering: none)[Bagian I - Menemukan Diri di Dalam Percakapan]
<bagian-i---menemukan-diri-di-dalam-percakapan>
...
#heading(level: 1, numbering: none)[Bagian II - Membangun Relasi yang Dipercaya]
<bagian-ii---membangun-relasi-yang-dipercaya>
...
#heading(level: 1, numbering: none)[Bagian III - Dari Ketertarikan Menuju Tindakan]
<bagian-iii---dari-ketertarikan-menuju-tindakan>
...
#heading(level: 1, numbering: none)[Bagian IV - Menjadi Komunikator Publik]
<bagian-iv---menjadi-komunikator-publik>
...
#heading(level: 1, numbering: none)[Bagian V - Menjadi Life Star]
<bagian-v---menjadi-life-star>
...
<glosarium>
#strong[Action] \ Tahap dalam TAIDA yang mengubah pemahaman dan keinginan menjadi langkah konkret.

#strong[Asertif] \ Cara berkomunikasi yang jujur dan jelas tentang pikiran, perasaan, kebutuhan, atau batas diri sambil tetap menghormati orang lain.

#strong[Attention] \ Tahap dalam TAIDA yang bertujuan membuka perhatian audiens melalui cerita, pertanyaan, data, pengalaman, atau pembuka lain yang relevan.

#strong[Cermin ganda] \ Metafora untuk kemampuan melihat ke dalam diri sekaligus membaca keadaan orang lain secara lebih jernih.

#strong[Desire] \ Tahap dalam TAIDA yang menumbuhkan keinginan audiens untuk menerima nilai, perubahan, atau tindakan yang ditawarkan.

#strong[Empati] \ Kemampuan memahami pengalaman, perasaan, dan kebutuhan orang lain tanpa harus kehilangan kejelasan diri.

#strong[Fakta] \ Hal yang dapat diamati atau diverifikasi dalam peristiwa komunikasi.

#strong[Interest] \ Tahap dalam TAIDA yang membangun relevansi sehingga audiens merasa pesan menyentuh kebutuhan atau pergumulannya.

#strong[Kehadiran diri] \ Cara seseorang hadir melalui tubuh, suara, ekspresi, niat, karakter, dan sikap dalam komunikasi.

#strong[Kepercayaan] \ Keyakinan bahwa seseorang dapat diandalkan karena integritas, kompetensi, konsistensi, dan niat baiknya.

#strong[Komunikasi interpersonal] \ Komunikasi antara pribadi yang melibatkan pesan, makna, emosi, konteks, dan relasi.

#strong[Komunikasi publik] \ Komunikasi kepada audiens yang lebih luas dengan tujuan memberi informasi, membangun pemahaman, mempengaruhi, atau menggerakkan tindakan.

#strong[Komunikator utuh] \ Sosok yang memadukan kompetensi, karakter, kasih, dan keberanian dalam berkomunikasi.

#strong[Konflik] \ Ketegangan yang muncul karena perbedaan kebutuhan, nilai, persepsi, kepentingan, atau harapan.

#strong[Makna] \ Arti yang ditangkap seseorang dari pesan, dipengaruhi oleh konteks, pengalaman, emosi, dan relasi.

#strong[Mendengar aktif] \ Kegiatan mendengar dengan perhatian penuh melalui parafrase, pertanyaan terbuka, validasi perasaan, dan keheningan yang sehat.

#strong[Niat baik] \ Orientasi hati yang memperhatikan kebaikan, martabat, dan kebutuhan pihak lain.

#strong[Nurani digital] \ Kesadaran etis dalam menggunakan media digital dan AI agar komunikasi tetap jujur, jelas, bertanggung jawab, dan manusiawi.

#strong[Parafrase] \ Mengungkapkan kembali inti pesan orang lain dengan kata-kata sendiri untuk memeriksa pemahaman.

#strong[Persona] \ Cara seseorang menampilkan diri dalam peran sosial atau publik.

#strong[Portofolio komunikasi] \ Kumpulan bukti, refleksi, karya, umpan balik, dan rencana pertumbuhan yang menunjukkan perkembangan kompetensi komunikasi.

#strong[TAIDA] \ Kerangka komunikasi yang terdiri dari Target, Attention, Interest, Desire, dan Action.

#strong[Target] \ Tahap awal TAIDA yang menetapkan perubahan atau hasil komunikasi yang diharapkan.

#strong[Validasi perasaan] \ Pengakuan bahwa emosi seseorang dapat dipahami dalam konteks tertentu, tanpa harus menyetujui semua tindakan atau kesimpulannya.
